...
//If user has already logged in, 
	...
	session.setAttribute("bookFunction", "edit");
...
<main>
    ...
    <div class="row d-flex justify-content-center">
      ...
      <div class="col-md-7 col-lg-8">
        <h4 class="mb-3">Edit Book Details</h4>
        <form class="needs-validation" action="<%=request.getContextPath()%>/BookDB" method="POST">
          <div class="row g-3">
            <div class="col-sm-6">
            ...
            <div class="col-sm-6">
              ...
              <input type="text" class="form-control" name="author" placeholder="" value="<%= author %>" required>
              <div class="invalid-feedback">
            ...
            <div class="col-sm-6">
              ...
              <input type="text" class="form-control" name="rating" placeholder="" value="<%= rating %>" required>
              <div class="invalid-feedback">
            ...
            <div class="col-sm-6">
              ...
              <input type="text" class="form-control" name="price" placeholder="" value="<%= price %>" required>
              <div class="invalid-feedback">
			...
			<div class="col-sm-6">
              ...
              <input type="text" class="form-control" name=category placeholder="" value="<%= category %>" required>
              <div class="invalid-feedback">
            ...
            <div class="col-sm-6">
              ...
              <input type="text" class="form-control" name="releaseDate" placeholder="" value="<%= releaseDate %>" required>
              <div class="invalid-feedback">
            ...
            <div class="col-10">
              <label for="username" class="form-label">ISBN Number</label>
              <div class="input-group has-validation">
                <input type="text" class="form-control" name="isbnStrNum" placeholder="" value=<%= isbnStr %> required>
              <div class="invalid-feedback">
                  isbnStr is required.
                </div>
              </div>
            ...
            <div class="col-2">
              ...
              <input type="number" class="form-control" name="quantity" placeholder="you@example.com" value="<%=quantity%>">
              <div class="invalid-feedback">
            ...
            <div class="col-12">
              ...
              <input type="text" class="form-control" name="publisher" placeholder="" required value="<%= publisher %>">
              <div class="invalid-feedback">
            ...
            <div class="col-12">
			  ...
			  <textarea class="form-control" placeholder="Leave a comment here" name="description"  style="height: 400px"><%= description %></textarea>
		  ...
		  <div class="container">
		   <div class="row">
		  	<div class="col">
		  		<input class="btn btn-success btn-block form-control" type="submit" name="save" value="Save details">
		  	</div>
		  	<div class="col">
        ...
        <form action="editBookPic.jsp" method="POST">
            <button type="submit" class="btn btn-primary">Edit Book Image</button>
        </form>
      </div>
    </div>
  </main>
