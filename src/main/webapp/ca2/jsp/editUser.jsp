...
<%
	...
	if (!role.equals("administrator") && !role.equals("member") && !role.equals("owner")) {
		response.sendRedirect("login.jsp");
	}
	
	//Get user attribute
	if (role.equals("administrator") || role.equals("owner")) {
		userStr = request.getParameter("userId");
	}
	...
	String userID = "", userName = "", userPassword = "", birthday = "", email = "", userRole = "", homeAddress = "";
	
	// Set user edit function
	session.setAttribute("userFunction", "edit");
	...
	try {
		...
		// Step 1: Load JDBC Driver
				...
				String sqlStr = "";
				if (role.equals("administrator") || role.equals("owner")) {
					sqlStr = "SELECT * FROM jad_bookstore_db.user WHERE iduser = ?";
				}
	
				else if (role.equals("member")) {
					sqlStr = "SELECT * FROM jad_bookstore_db.user WHERE name = ?";
				}
				...
				if (rs.next()) {
					...
					homeAddress = rs.getString("address");
				}
...
<main>
    <div class="py-5 text-center">
      ...
      <%
	  		...
	  		if (message != null && message.equals("editError")) {
				out.print("Error.. <br><h2>Please try again!</h2>");
			}
			
			else if (message != null && message.equals("editSuccess")) {
    ...
    <div class=" d-flex justify-content-center">
      ...
      <h4 class="mb-3">Edit User Details</h4>
        <form class="needs-validation" novalidate="" action="<%=request.getContextPath()%>/UserDB" method="POST">
          <div class="row g-3">
            <div class="col-sm-6">
              <label for="firstName" class="form-label">Name</label>
              <input type="text" class="form-control" name="userName" placeholder="" value="<%= userName %>" required>
            ...
            <div class="col-sm-6">
              ...
              <input type="text" class="form-control" name="userPassword" placeholder="" value="<%= userPassword %>" required>
              <div class="invalid-feedback">
            ...
            <div class="col-sm-6">
              ...
              <input type="text" class="form-control" name="birthday" placeholder="" value="<%= birthday %>" required>
              <div class="invalid-feedback">
            ...
            <div class="col-sm-6">
              ...
              <input type="text" class="form-control" name=homeAddress placeholder="" value="<%= homeAddress %>" required>
              <div class="invalid-feedback">
                Valid home address is required.
              </div>
            </div>

			<div class="col-sm-6">
              <label class="form-label">Role</label>
              <input type="text" class="form-control" name=userRole placeholder="" value="<%= userRole %>" required>
              <div class="invalid-feedback">
