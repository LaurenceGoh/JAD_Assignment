...
<title>Sales Book Stats Page</title>
<link rel="canonical"
...
<div class="container col-xxl-8 px-4 py-5">
    <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
      ...
      <div class="col-lg-6">
        ...
        <p><b>Unit Sold: <%= unitSold %></b></p>
        <div class="d-grid gap-2 d-md-flex justify-content-md-start">
        	<form action="salesBookSelect.jsp" method="POST" >
        		<%
        			out.print("<input type=\"submit\" class=\"btn btn-primary btn-lg px-4 me-md-2\" value=\"Back\">");
        		%>
        	</form>
        </div>
      </div>
